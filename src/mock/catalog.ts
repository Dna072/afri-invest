...
export const MARKET_SEED = [
  {
    ...
    description: "Ghana is the first modelled market. Equities, treasuries and funds are available in the sandbox.",
...
export const ASSET_SEED: AssetSeed[] = [
  ...
  { symbol: "CPC", name: "Cocoa Processing", issuer: "Cocoa Processing Company", marketId: "ghana", exchangeId: "gse", country: "Ghana", currency: "GHS", assetType: "equity", description: "Sandbox listing. Agribusiness processor. Prices are illustrative.", riskCategory: "high", tradability: "open", minimumInvestment: "20", price: "0.05", previousClose: "0.05", changePercent: "0.00", sector: "Materials" },
];

export const ARTICLES = [
  { slug: "getting-started", title: "How Africa Invest works", category: "Getting Started", readMinutes: 4, body: "Africa Invest is designed so you can hold one investment account and, over time, reach African markets. This MVP uses sandbox market data and mock providers. It is not a live brokerage." },
  { slug: "african-markets", title: "A tour of African exchanges", category: "African Markets", readMinutes: 6, body: "Ghana, Nigeria, Kenya, South Africa and the BRVM each have different currencies, calendars and regulators. Adding a market is a configuration and partner exercise, not a rewrite of the ledger." },
  ...
  { slug: "bonds-basics", title: "Government securities in plain language", category: "Bonds", readMinutes: 5, body: "Treasury bills and bonds are how governments borrow. Yields in this product are indicative sandbox figures." },
  ...
  { slug: "risk", title: "Risk is not a slogan", category: "Risk", readMinutes: 5, body: "You can lose capital. Currency moves can amplify gains and losses for diaspora investors." },
  ...
  { slug: "fx-diaspora", title: "SEK to GHS, without the mystery", category: "FX", readMinutes: 5, body: "You see the source rate, spread, platform fee and amount received. Quotes expire. This is how we keep FX honest." },
  { slug: "long-term", title: "Long-term investing", category: "Long-term Investing", readMinutes: 6, body: "Recurring investments exist to make contributions boring. Returns are not guaranteed." },
];
