    ...
    <div className="space-y-5">
      ...
      {step === "done" ? (
        <div className="rounded-3xl bg-primary p-6 text-primary-foreground">
          ...
          <p className="mt-2 font-display text-3xl">The sandbox broker has settled this order.</p>
          <p className="mt-3 text-sm text-primary-foreground/80">Your portfolio and ledger have been updated. Order {orderId}</p>
